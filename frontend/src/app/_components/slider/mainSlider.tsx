                ...
                {slides.map((slide, idx) => {
                    ...
                    return (
                        <div key={`slide-${slide._id}`} className='h-[400px] w-full'>
                            ...
                            <NextImage src={slide.image} fill  sizes="(max-width:320px) 80vw, (max-width:640px) 80vw, (max-width:768px) 30vw, (max-width:1200px) 15vw, 10vw" priority={idx === 0} 
                            unoptimized placeholder='blur' blurDataURL={slide.image} alt={`Cover Image of ${slide.name}`} className='rounded shadow slider-img sm:max-w-[300px]' style={{
                                objectFit: 'cover'
                            }}>
